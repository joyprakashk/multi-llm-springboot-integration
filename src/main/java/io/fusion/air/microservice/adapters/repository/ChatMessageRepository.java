...
public interface ChatMessageRepository extends JpaRepository<ChatMessageEntity, UUID> {
     ...
     * @return
     */
    @Query("SELECT chat FROM ChatMessageEntity chat WHERE chat.userId like :userId ")
    public List<ChatMessageEntity> fetchByUserId(@Param("userId") String userId);
